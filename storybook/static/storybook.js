// Storybook-only: registers EzAuth LiveView hooks with phoenix_storybook's
// LiveSocket so JS-driven components (code_input, ...) work in the preview.
// Kept in sync with priv/static/ez_auth.js.
const PATTERNS = {
  numeric: /[^0-9]/g,
...
window.storybook = { Hooks: { CodeInput } };
